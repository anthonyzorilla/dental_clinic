...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="/images/dentaltech-icon.jpg" />
				...
				<div class="col-lg-6">
					<div class="text-lg-right top-right-bar mt-2 mt-lg-0">
						<a href="tel:+23-345-67890" >
							<span>Call Now : </span>
							<span class="h4">823-4565-13453</span>
						</a>
					</div>
				</div>
			</div>
	...
	<nav class="navbar navbar-expand-lg navigation" id="navbar">
		<div class="container">
		 	 <a class="navbar-brand" href="index.php">
			  	<img src="images/dentaltech-logo-212x60-whitebg.jpg" alt="" class="img-fluid">
			  </a>
